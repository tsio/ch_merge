...
--
-- Name: enstore2chimera(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.enstore2chimera() OWNER TO postgres;

--
-- Name: f_create_inode(bigint, character varying, character varying, integer, integer, integer, integer, integer, bigint, integer, timestamp without time zone); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.f_create_inode(parent bigint, name character varying, id character varying, type integer, mode integer, nlink integer, uid integer, gid integer, size bigint, io integer, now timestamp without time zone) OWNER TO postgres;

--
-- Name: f_create_inode(character varying, character varying, character varying, integer, integer, integer, integer, integer, bigint, integer, timestamp without time zone); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.f_create_inode(parent character varying, name character varying, id character varying, type integer, mode integer, nlink integer, uid integer, gid integer, size bigint, io integer, now timestamp without time zone) OWNER TO postgres;

--
-- Name: f_enstore2uri(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.f_enstore2uri(character varying) OWNER TO postgres;

--
-- Name: f_enstorelevel2locationinfo(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.f_enstorelevel2locationinfo() OWNER TO postgres;

--
-- Name: f_locationinfo2trash(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.f_locationinfo2trash() OWNER TO postgres;

--
-- Name: inode2path(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.inode2path(character varying) OWNER TO postgres;

--
-- Name: inumber2path(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.inumber2path(bigint) OWNER TO postgres;

--
-- Name: inumber2pnfsid(bigint); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.inumber2pnfsid(bigint) OWNER TO postgres;

--
-- Name: path2inode(character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.path2inode(root character varying, path character varying) OWNER TO postgres;
...
--
-- Name: t_inodes; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_inodes OWNER TO postgres;

--
-- Name: COLUMN t_inodes.icrtime; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN t_inodes.igeneration; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN t_inodes.iaccess_latency; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN t_inodes.iretention_policy; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: path2inodes(bigint, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.path2inodes(root bigint, path character varying, OUT inode t_inodes) OWNER TO postgres;

--
-- Name: path2inumber(bigint, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.path2inumber(root bigint, path character varying) OWNER TO postgres;

--
-- Name: pnfsid2inumber(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.pnfsid2inumber(character varying) OWNER TO postgres;

--
-- Name: uri_decode(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.uri_decode(input_txt text) OWNER TO postgres;

--
-- Name: uri_encode(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.uri_encode(input_txt text) OWNER TO postgres;
...
--
-- Name: t_acl; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_acl OWNER TO postgres;

--
-- Name: t_dirs; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_dirs OWNER TO postgres;
...
ALTER TABLE t_groups OWNER TO postgres;

--
-- Name: t_inodes_checksum; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_inodes_checksum OWNER TO postgres;

--
-- Name: t_inodes_data; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_inodes_data OWNER TO postgres;

--
-- Name: t_inodes_inumber_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_inodes_inumber_seq OWNER TO postgres;

--
-- Name: t_inodes_inumber_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_1; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_level_1 OWNER TO postgres;

--
-- Name: t_level_2; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_level_2 OWNER TO postgres;

--
-- Name: t_level_3; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_level_3 OWNER TO postgres;

--
-- Name: t_level_4; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_level_4 OWNER TO postgres;

--
-- Name: t_level_5; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_level_5 OWNER TO postgres;

--
-- Name: t_level_6; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_level_6 OWNER TO postgres;

--
-- Name: t_level_7; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_level_7 OWNER TO postgres;

--
-- Name: t_locationinfo; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_locationinfo OWNER TO postgres;

--
-- Name: t_locationinfo_trash; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_locationinfo_trash OWNER TO postgres;

--
-- Name: t_storageinfo; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_storageinfo OWNER TO postgres;
...
ALTER TABLE t_tags OWNER TO postgres;

--
-- Name: t_tags_inodes; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_tags_inodes OWNER TO postgres;

--
-- Name: t_tags_inodes2_itagid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE t_tags_inodes2_itagid_seq OWNER TO postgres;

--
-- Name: t_tags_inodes2_itagid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: inumber; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: itagid; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_acl; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_dirs; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_inodes; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
00007BF09A4E00A34074A36712C18FC85B49	16384	511	2	0	0	512	0	2016-06-27 15:15:42.495	2016-06-27 15:15:42.495	2016-06-27 15:15:42.495	2016-06-27 15:15:42.495	0	\N	\N	3
000000000000000000000000000000000000	16384	511	4	0	0	512	0	2016-06-27 15:15:42.495	2016-06-27 15:15:12.630086	2016-06-27 15:15:42.495	2016-06-27 15:15:12.630086	1	\N	\N	1
\.


--
-- Data for Name: t_inodes_checksum; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_inodes_data; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: t_inodes_inumber_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('t_inodes_inumber_seq', 3, true);


--
-- Data for Name: t_level_1; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_level_2; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_level_3; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_level_4; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_level_5; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_level_6; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_level_7; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_locationinfo; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_locationinfo_trash; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_storageinfo; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: t_tags_inodes; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: t_tags_inodes2_itagid_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: i_inodes_inumber; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_acl_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_dirs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_groups_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_inodes_checksum_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_inodes_data_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_inodes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_1_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_2_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_3_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_4_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_5_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_6_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_7_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_locationinfo_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_locationinfo_trash_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_storageinfo_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_tags_inodes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: i_dirs_ichild; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: i_locationinfo_trash_itype_ilocation; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: i_tags_itagid; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: tgr_enstore_location; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: tgr_locationinfo_trash; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: t_acl_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_dirs_ichild_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_dirs_iparent_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_inodes_checksum_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_inodes_data_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_1_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_2_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_3_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_4_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_5_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_6_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_level_7_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_locationinfo_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_storageinfo_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_tags_inumber_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: t_tags_itagid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
